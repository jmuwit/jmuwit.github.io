...
define('SMTP_USERNAME', 'jmuwit@gmail.com'); // Username for SMTP authentication any valid email created in your domain
define('SMTP_PASSWORD', 'womenintechnology1'); // Password for SMTP authentication
...
if (isset($_POST['name']) AND isset($_POST['email']) AND isset($_POST['message']))
{
    ...
    $set_from = 'WIT Contact';
    $subject = 'WIT: Message from ' . $name . '!';
